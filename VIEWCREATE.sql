...
SELECT 
U.USERNAME_ KULLANICIADI  , U.NAMESURNAME ADSOYAD ,C.COUNTRY ULKE ,CT.CITY SEHIR ,T.TOWN ILCE , A.ADDRESSTEXT ACIKADRES
...
SELECT SEHIR ,SUM(SATIRTOPLAMI) AS  SATIRTOPLAMI ,COUNT(*)  AS TOPLAMI FROM VWORDERS
GROUP BY SEHIR 